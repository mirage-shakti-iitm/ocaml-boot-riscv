...
void boot_primary() {
    ...
    // caml_startup(argv);
    main();
    boot_printf("\n \n 0x%016lx Performance numbers : \n compartment Exceptions : 0x%016lx ; \n cycles spent in compartments exceptions : 0x%016lx ; \n cycles spent in hash instruction : 0x%016lx ; \n cycles spent in val instructiossn : 0x%016lx ; \n Total cycles spent : 0x%016lx \n", read_csr(mcycle), read_csr(mhpmcounter3), read_csr(mhpmcounter4), read_csr(mhpmcounter5), read_csr(mhpmcounter6), read_csr(mcycle));
