...
#define CSR_MCHECKCAPSP 0x7fe
#define CSR_MCROSSCOMP_EXCEPTION 0x7fd
...
#define CAUSE_TEE_COMPARTMENT_EXCEPTION 0x10
...
DECLARE_CAUSE("tee compartment exception", CAUSE_TEE_COMPARTMENT_EXCEPTION)
