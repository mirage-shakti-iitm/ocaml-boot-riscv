...
# generate kernel_cap
riscv64-unknown-elf-gcc -mcmodel=medany ${test_program_dir}/hello -o ${output_dir}/${kernel_name} -static -nostdlib -nostartfiles -Wl,-T ${LINKER_PATH}/linker.x -Wl,--start-group ${output_dir}/${libboot_name} -Wl,--end-group
